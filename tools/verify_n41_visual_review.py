...
EXPECTED_N41_B_NATURAL_FLIGHT = "cb3cd2654dcd4fa9def34fb0145645f5d61b59c96c407669cf1e9dd4f12628ef"
...
def main() -> None:
    ...
    n41_b_natural_flight = root / "crates/mechofly-core/parameters/n4.1-soft-fatigue-b-natural-flight-v3.json"
    ...
    require(runtime, "BehaviorParameterProfile::N41BNaturalFlight", "pinned natural-flight selection")
    ...
    require(main_rs, 'active_profile: "n41-b-natural-flight"', "active review attestation")
    ...
    for text, marker, label in (
        ...
        (
            ...
            "offline flight-function loading",
        ),
    ):
    ...
    receipt = {
        ...
        "n41_b_natural_flight_parameter_sha256": EXPECTED_N41_B_NATURAL_FLIGHT,
    ...
    print("N41_VISUAL_REVIEW_INTEGRATION=PASS canonical=n4 review=n41-b-natural-flight deploy=false")
